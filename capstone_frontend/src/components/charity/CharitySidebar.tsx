import { LayoutDashboard, Building2, Megaphone, DollarSign, TrendingUp, User, Settings, Trash2, AlertTriangle } from "lucide-react";
...
const navItems = [
  ...
  { title: "Reports", url: "/charity/reports/issues", icon: AlertTriangle },
