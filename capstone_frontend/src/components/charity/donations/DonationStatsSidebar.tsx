        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="text-2xl font-bold text-primary">
              ₱{(stats.totalReceived || 0).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="text-2xl font-bold">
              ₱{(stats.totalThisMonth || 0).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="text-xl font-bold">
              ₱{(stats.averageDonation && !isNaN(stats.averageDonation) ? stats.averageDonation : 0).toLocaleString('en-PH', {
