...
class CampaignService {
  ...
  /**
   * Get all campaigns for the authenticated charity admin
   * (No charity ID needed - automatically uses the logged-in user's charity)
   */
  async getMyCampaigns(page: number = 1): Promise<PaginatedResponse<Campaign>> {
  ...
  /**
   * Get all campaigns for a specific charity (public view)
   */
