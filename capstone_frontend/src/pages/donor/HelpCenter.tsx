...
const faqData: FAQItem[] = [
  ...
  // General
  {
    ...
    answer: "You can contact our support team by creating a support ticket (click the 'Support Tickets' button below), or by emailing support@charityhub.com. We typically respond within 24 hours."
  },
  {
    category: "General",
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-background border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Help Center</h1>
