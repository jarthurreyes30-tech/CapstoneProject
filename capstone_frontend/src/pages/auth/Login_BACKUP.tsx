      ...
      <div className="w-full max-w-md">
        ...
        <div className="auth-card">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Two-Factor Code (shown only if required) */}
            {requires2FA && (
              <div className="space-y-2">
                <Label htmlFor="two_factor_code">Two-Factor Code</Label>
                <Input
                  id="two_factor_code"
                  type="text"
                  placeholder="000000"
                  ...
                  required
                  maxLength={6}
                  className={cn(errors.two_factor_code && 'border-destructive', 'text-center text-2xl font-mono tracking-widest')}
                  autoFocus
                />
