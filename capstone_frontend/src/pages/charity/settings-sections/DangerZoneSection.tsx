...
export default function DangerZoneSection() {
  ...
  const handleDeactivate = async () => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL}/charities/${user.charity.id}/deactivate`, {
        method: 'POST',
        headers: {
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="You can share a reason for deactivating (optional)"
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={submitting || !deactivatePassword.trim()}
            >
